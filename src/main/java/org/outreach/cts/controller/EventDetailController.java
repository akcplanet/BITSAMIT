...
public class EventDetailController extends BaseController {
	...
	@Path("/byid/{id}")
	@Produces(MediaType.APPLICATION_JSON)
	public EventDetails getByIdEventDetails(@PathParam("id") String id) {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public void updateEventDetails(@PathParam("id") String id, EventDetails sd) {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public void deleteEventDetails(@PathParam("id") String id) {
